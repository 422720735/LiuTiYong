<template>
  <div class="article-box">
    <ArtickeContent
      v-if="articleDetail && articleDetail.data "
      :article-detail="articleDetail.data"></ArtickeContent>
    <!--是不是喜欢-->
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      user: ({auth}) => auth.user,
      nextArticle: ({articleDetail}) => articleDetail.item.next,
      prevArticle: ({articleDetail}) => articleDetail.item.prev,
