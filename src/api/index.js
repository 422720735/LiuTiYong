import {UserResource,AuthResource,ArticleResource,TagResource,MobileResource,CommentResource, GetArticleInfo} from './resources'
...
export default {
  ...
  getArticelInfo: function(id) {
    return GetArticleInfo.get({id: id})
  },
